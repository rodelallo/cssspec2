...
public final class Main extends JFrame implements ActionListener{
    ...
    private static JButton enter = new JButton("=");
    ...
    public Main() throws FileNotFoundException{
      ...
      one.setBounds(0,80,60,20);
      two.setBounds(0,100,60,20);
      three.setBounds(0,120,60,20);
      four.setBounds(0,140,60,20);
      five.setBounds(0,160,60,20);
      six.setBounds(60,80,60,20);
      seven.setBounds(60,100,60,20);
      eight.setBounds(60,120,60,20);
      nine.setBounds(60,140,60,20);
      zero.setBounds(60,160,60,20);
      add.setBounds(120,80,60,20);
      subtract.setBounds(120,100,60,20);
      multiply.setBounds(120,120,60,20);
      divide.setBounds(120,140,60,20);
      enter.setBounds(120,160,60,20);
